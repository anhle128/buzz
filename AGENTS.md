...
This project is indexed by GitNexus as **buzz** (58891 symbols, 149241 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/buzz/context` | Codebase overview, check index freshness |
| `gitnexus://repo/buzz/clusters` | All functional areas |
| `gitnexus://repo/buzz/processes` | All execution flows |
| `gitnexus://repo/buzz/process/{name}` | Step-by-step execution trace |
