// Included from lib.rs so generate_handler! resolves crate-root command macros.
/// Desktop invoke handler for every registered Tauri command.
pub(crate) fn desktop_invoke_handler<R: tauri::Runtime>()
    -> impl Fn(tauri::ipc::Invoke<R>) -> bool + Send + Sync + 'static
where
    for<'de> tauri::AppHandle: tauri::ipc::CommandArg<'de, R>,
    for<'de> tauri::Window: tauri::ipc::CommandArg<'de, R>,
{
